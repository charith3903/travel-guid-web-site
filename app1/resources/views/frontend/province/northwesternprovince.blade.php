                ...
                <div class="col-lg-12">
                    <div class="section-heading">
                        ...
                        <div style="margin: 0 auto; max-width: 800px; text-align: justify; padding: 20px;">
                            ...
                            <p style="font-size: 16px; line-height: 1.5; color: #555;">The North Western Province is home to several ancient cities and archaeological sites that reflect its rich history and cultural heritage. Anuradhapura, one of the oldest continuously inhabited cities in the world, was once the capital of ancient Sri Lanka and is now a UNESCO World Heritage Site. Visitors can explore the ruins of magnificent palaces, temples, and stupas, including the iconic Ruwanwelisaya and Jetavanaramaya.</p>
                            <h4 style="color: #EFDDB6; margin-top: 30px;">Wildlife Sanctuaries</h4>
                            <p style="font-size: 16px; line-height: 1.5; color: #555;">In addition to its historical sites, the North Western Province is home to several wildlife sanctuaries and nature reserves. Wilpattu National Park, the largest national park in Sri Lanka, is renowned for its dense forests, serene lakes, and diverse wildlife, including leopards, elephants, and sloth bears. Visitors can embark on thrilling jeep safaris to explore the park's untamed wilderness and observe its resident wildlife in their natural habitat.</p>
                            ...
                            <ul style="list-style-type: disc; font-size: 16px; line-height: 1.5; color: #555;">
                                ...
                                <li>Kalpitiya Peninsula</li>
                                <li>Panduwasnuwara</li>
                                <li>Ridi Viharaya</li>
                                <li>Thalawila</li>
                                <li>Negombo Beach</li>
                                <li>Madu Ganga River Safari</li>
                            </ul>
                            <h4 style="color: #EFDDB6; margin-top: 30px;">Cultural Experiences</h4>
                            <p style="font-size: 16px; line-height: 1.5; color: #555;">Visitors to the North Western Province can immerse themselves in the region's vibrant culture and traditions. The annual Poson Festival, celebrated in Anuradhapura, commemorates the introduction of Buddhism to Sri Lanka and attracts pilgrims from across the country. The Kalpitiya Dolphin Festival offers a unique opportunity to witness playful dolphins and graceful whales in their natural habitat, making it a must-visit event for nature enthusiasts and wildlife lovers.</p>
                        </div>
                    </div>
                </div>
            </div>
